...
import { getAttestationUrl } from "~~/utils/attestationUrl";

interface IFinalOutput {
  output: IOutput[];
}

const FinalOutput = ({ output }: IFinalOutput) => {
  ...
  return (
    <div className="w-full bg-purple-600/10 backdrop-blur-sm rounded-lg border border-white/20 p-4 mt-6">
      ...
      {/* Attestation Details */}
      <div className="flex items-center justify-center overflow-x-auto space-x-6 pb-1 mt-6">
