...
const Chat = () => {
        ...
        try {
            ...
            const {
                ...
                `${process.env.NEXT_PUBLIC_MARKETPLACE_BACKEND_URL}/execute`,
                {
                    ...
                    chainId: 84532,
                    userAddress: "0x72d2F62A93305752CC57D48Ea217CA687EA43dc0",
                }
            );
    ...
    return (
        <div
            className={`flex flex-col ${isPreFetchingQuote ? "h-[50vh]" : "h-[80vh]"
                } bg-white`}
        >
            {isPreFetchingQuote ? (
                ...
                <div className="flex-grow overflow-auto p-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="text-sm pl-10 pt-2">{response}</div>
                        </div>
                    </div>
                </div>
            )}
            ...
            <footer
                className={`p-4 relative mt-4 ${isPreFetchingQuote ? "border-none" : "border-t"
                    }`}
            >
            ...
            {/* todo: add pre-fetching quote UI */}
